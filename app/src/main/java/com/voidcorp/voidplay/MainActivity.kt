...
import com.voidcorp.voidplay.data.github.GitHubAnnouncementPropertiesService
import com.voidcorp.voidplay.data.github.PlayStoreAnnouncementRemoteConfig
...
import com.voidcorp.voidplay.presentation.components.AllFilesAccessDialog
import com.voidcorp.voidplay.presentation.components.AppSidebarDrawer
import com.voidcorp.voidplay.presentation.components.CrashReportDialog
import com.voidcorp.voidplay.presentation.components.DismissUndoBar
import com.voidcorp.voidplay.presentation.components.DrawerDestination
import com.voidcorp.voidplay.presentation.components.MiniPlayerBottomSpacer
...
import com.voidcorp.voidplay.presentation.components.NavBarContentHeightFullWidth
import com.voidcorp.voidplay.presentation.components.PlayerInternalNavigationBar
import com.voidcorp.voidplay.presentation.components.PlayStoreAnnouncementDefaults
import com.voidcorp.voidplay.presentation.components.PlayStoreAnnouncementDialog
import com.voidcorp.voidplay.presentation.components.PlayStoreAnnouncementUiModel
import com.voidcorp.voidplay.presentation.components.UnifiedPlayerSheet
import com.voidcorp.voidplay.presentation.components.UnifiedPlayerSheetV2
import com.voidcorp.voidplay.presentation.navigation.AppNavigation
import com.voidcorp.voidplay.presentation.navigation.Screen
import com.voidcorp.voidplay.presentation.screens.SetupScreen
import com.voidcorp.voidplay.presentation.viewmodel.MainViewModel
...
import com.voidcorp.voidplay.utils.LogUtils
...
import com.voidcorp.voidplay.presentation.utils.AppHapticsConfig
import com.voidcorp.voidplay.presentation.utils.LocalAppHapticsConfig
import com.voidcorp.voidplay.presentation.utils.NoOpHapticFeedback
...
class MainActivity : ComponentActivity() {
    ...
    private fun handleIntent(intent: Intent?) {
        ...
        when {
            ...
            intent.action == "com.voidcorp.voidplay.ACTION_PLAY_SONG" -> {
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
                     intent.getParcelableExtra("song", com.voidcorp.voidplay.data.model.Song::class.java)?.let { song ->
                         playerViewModel.playSong(song)
                     }
                } else {
                     @Suppress("DEPRECATION")
                     intent.getParcelableExtra<com.voidcorp.voidplay.data.model.Song>("song")?.let { song ->
                         playerViewModel.playSong(song)
                     }
                }
                intent.action = null
    ...
    companion object {
        const val ACTION_SHUFFLE_ALL = "com.voidcorp.voidplay.ACTION_SHUFFLE_ALL"
        const val ACTION_OPEN_PLAYLIST = "com.voidcorp.voidplay.ACTION_OPEN_PLAYLIST"
                ...
                onDestinationSelected = { destination ->
                    ...
                    when (destination) {
                        ...
                        DrawerDestination.Telegram -> {
                            val intent = Intent(this@MainActivity, com.voidcorp.voidplay.presentation.telegram.auth.TelegramLoginActivity::class.java)
                            startActivity(intent)
                        }
                        else -> {}
                    }
