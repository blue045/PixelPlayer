...
@Database(
    ...
    version = 25, // Added bpm and mood columns to songs table
...
abstract class VoidPlayDatabase : RoomDatabase() {
    ...
    companion object {
        ...
        val MIGRATION_24_25 = object : Migration(24, 25) {
            override fun migrate(db: SupportSQLiteDatabase) {
                db.execSQL("ALTER TABLE songs ADD COLUMN bpm INTEGER DEFAULT NULL")
                db.execSQL("ALTER TABLE songs ADD COLUMN mood TEXT DEFAULT NULL")
            }
        }
    }
}
