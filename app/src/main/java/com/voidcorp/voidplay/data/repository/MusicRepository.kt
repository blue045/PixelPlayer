...
interface MusicRepository {
    ...
    fun getPaginatedFavoriteSongs(
        ...
        storageFilter: com.voidcorp.voidplay.data.model.StorageFilter = com.voidcorp.voidplay.data.model.StorageFilter.ALL
     ...
     */
    fun getAlbums(storageFilter: com.voidcorp.voidplay.data.model.StorageFilter = com.voidcorp.voidplay.data.model.StorageFilter.ALL): Flow<List<Album>> // Existing Flow for reactive updates
     ...
     */
    fun getGenres(): Flow<List<com.voidcorp.voidplay.data.model.Genre>>
    ...
    fun getMusicFolders(
        storageFilter: com.voidcorp.voidplay.data.model.StorageFilter = com.voidcorp.voidplay.data.model.StorageFilter.ALL
    ): Flow<List<com.voidcorp.voidplay.data.model.MusicFolder>>
    ...
    val telegramRepository: com.voidcorp.voidplay.data.telegram.TelegramRepository
