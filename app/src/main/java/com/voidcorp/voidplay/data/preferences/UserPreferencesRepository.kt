...
constructor(
    ...
    val appIconFlow: Flow<String> = dataStore.data.map {
        it[PreferencesKeys.APP_ICON] ?: "MainActivityAmoled"
    }

    suspend fun setAppIcon(iconAlias: String) {
        dataStore.edit {
            it[PreferencesKeys.APP_ICON] = iconAlias
        }
    }
}
