...
import com.voidcorp.voidplay.data.media.ImageCacheManager
import com.voidcorp.voidplay.data.media.MetadataEditError
...
import com.voidcorp.voidplay.utils.FileDeletionUtils
    ...
    suspend fun saveMetadata(
        ...
        val finalCoverArtUpdate = if (coverArtUpdate == null) {
            val existingMetadata = try {
                 com.voidcorp.voidplay.data.media.AudioMetadataReader.read(java.io.File(song.path))
            } catch (e: Exception) {
                null
            }
