...
import com.voidcorp.voidplay.data.repository.NoLyricsFoundException
...
class LyricsStateHolder @Inject constructor(
    ...
    fun initialize(
        ...
        stablePlayerState: StateFlow<com.voidcorp.voidplay.presentation.viewmodel.StablePlayerState>
    ) {
