package com.voidcorp.voidplay.presentation.telegram.channel
...
import com.voidcorp.voidplay.presentation.viewmodel.ConnectivityStateHolder
        ...
        viewModelScope.launch {
            ...
            if (fetchedSongs.isNotEmpty()) {
                ...
                if (chat != null) {
                    ...
                    val entity = com.voidcorp.voidplay.data.database.TelegramChannelEntity(
                        chatId = chat.id,
                        title = chat.title,
