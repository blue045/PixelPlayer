...
import com.voidcorp.voidplay.utils.IconSwitcher
import java.io.File
...
data class SettingsUiState(
    ...
    val appIcon: String = "MainActivityAmoled"
)
...
class SettingsViewModel @Inject constructor(
    ...
    init {
        ...
        viewModelScope.launch {
            userPreferencesRepository.appIconFlow.collect { icon ->
    ...
    fun setAppIcon(iconAlias: String) {
        viewModelScope.launch {
            userPreferencesRepository.setAppIcon(iconAlias)
            IconSwitcher.setIcon(context, iconAlias)
        }
    }
}
